          ...
          <Row>
            <Col xxl={12}>
              <div className="breadcrumb__content">
                <h3 className="breadcrumb__title">MIS Development</h3>
                <div className="breadcrumb__list">
                  <span><a href="Home">Home</a></span>
                  <span className="dvdr">/</span>
                  <span>MIS Development</span>
                </div>
              </div>
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col>
              <div class="pg-section__title-wrapper">
                <span class=" pg-section__subtitle-lg ">MIS Development</span>
                <h3 class="pg-section__title-lg ">MIS Development Services with <br/> IFLEX Technologies</h3>
