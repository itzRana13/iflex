          ...
          <Row>
            <Col xxl={12}>
              <div className="breadcrumb__content">
                <h3 className="breadcrumb__title">UI/UX Design</h3>
                <div className="breadcrumb__list">
                  <span><a href="Homes">Home</a></span>
          ...
          <Row>
            ...
            <Col>
              <div class="pg-section__title-wrapper">
                <span class=" pg-section__subtitle-lg ">UI/UX Design</span>
                <h3 class="pg-section__title-lg ">UI/UX Design Services with <br/> IFLEX Technologies</h3>
